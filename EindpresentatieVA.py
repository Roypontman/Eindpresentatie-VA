...
if pages == 'Home':
    ...
    datum_jaar = st.date_input("Kies hier een datum voor het watergebuik", datetime.datetime(2003),
                      min_value = datetime.datetime(2003), max_value = datetime.datetime(2020))
